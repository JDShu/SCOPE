...
* In the email section, the "Enable posting problems and comments by email" controls whether the feature is enabled or disabled.
...
* The last setting in this section controls the threshold for minimum length of the reply that is posted as an problem to a exercise. If the user is replying to a notification for a exercise and the reply  body is shorter than this threshold the reply will be posted as a comment to the exercise.
* In the karma thresholds section the "Post problems and comments by email" defines the minimum karma for users to be able to post replies by email.
