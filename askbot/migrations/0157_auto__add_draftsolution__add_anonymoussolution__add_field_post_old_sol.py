...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DraftSolution'
        db.create_table('askbot_draftsolution', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(related_name='draft_solutions', to=orm['askbot.Post'])),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(related_name='draft_solutions', to=orm['auth.User'])),
            ('text', self.gf('django.db.models.fields.TextField')(null=True)),
        ))
        db.send_create_signal('askbot', ['DraftSolution'])

        # Adding model 'AnonymousSolution'
        db.create_table('askbot_anonymoussolution', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(related_name='anonymous_solutions', to=orm['askbot.Post'])),
        ))
        db.send_create_signal('askbot', ['AnonymousSolution'])

        # Adding field 'Post.old_solution_id'
        db.add_column('askbot_post', 'old_solution_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=None, unique=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'DraftSolution'
        db.delete_table('askbot_draftsolution')

        # Deleting model 'AnonymousSolution'
        db.delete_table('askbot_anonymoussolution')

        # Deleting field 'Post.old_solution_id'
        db.delete_column('askbot_post', 'old_solution_id')
    ...
    models = {
        ...
        'askbot.anonymoussolution': {
            'Meta': {'object_name': 'AnonymousSolution'},
            'added_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'author': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ip_addr': ('django.db.models.fields.IPAddressField', [], {'max_length': '15'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'anonymous_solutions'", 'to': "orm['askbot.Post']"}),
            'session_key': ('django.db.models.fields.CharField', [], {'max_length': '40'}),
            'summary': ('django.db.models.fields.CharField', [], {'max_length': '180'}),
            'text': ('django.db.models.fields.TextField', [], {}),
            'wiki': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        ...
        'askbot.draftsolution': {
            'Meta': {'object_name': 'DraftSolution'},
            'author': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'draft_solutions'", 'to': "orm['auth.User']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'draft_solutions'", 'to': "orm['askbot.Post']"}),
            'text': ('django.db.models.fields.TextField', [], {'null': 'True'})
        },
        ...
        'askbot.group': {
            ...
            'moderate_problems_to_enquirers': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        'askbot.post': {
            ...
            'old_solution_id': ('django.db.models.fields.PositiveIntegerField', [], {'default': 'None', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'child_post'", 'null': 'True', 'to': "orm['askbot.Post']"}),
        ...
        'askbot.thread': {
            ...
            'solution_count': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'tagnames': ('django.db.models.fields.CharField', [], {'max_length': '125'}),
