...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'PostRevision', fields ['exercise', 'revision']
        db.delete_unique('askbot_postrevision', ['exercise_id', 'revision'])

        # Removing unique constraint on 'PostRevision', fields ['problem', 'revision']
        db.delete_unique('askbot_postrevision', ['problem_id', 'revision'])

        # Deleting field 'Thread.accepted_problem'
        db.delete_column('askbot_thread', 'accepted_problem_id')

        # Deleting field 'AnonymousProblem.exercise'
        db.delete_column('askbot_anonymousproblem', 'exercise_id')

        # Changing field 'AnonymousProblem.exercise_post'
        db.alter_column('askbot_anonymousproblem', 'exercise_post_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['askbot.Post']))

        # Deleting field 'ExerciseView.exercise'
        db.delete_column('askbot_exerciseview', 'exercise_id')

        # Changing field 'ExerciseView.exercise_post'
        db.alter_column('askbot_exerciseview', 'exercise_post_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['askbot.Post']))

        # Deleting field 'PostRevision.exercise'
        db.delete_column('askbot_postrevision', 'exercise_id')

        # Deleting field 'PostRevision.problem'
        db.delete_column('askbot_postrevision', 'problem_id')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Thread.accepted_problem'
        db.add_column('askbot_thread', 'accepted_problem', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['askbot.Problem'], null=True, blank=True), keep_default=False)

        # User chose to not deal with backwards NULL issues for 'AnonymousProblem.exercise'
        raise RuntimeError("Cannot reverse this migration. 'AnonymousProblem.exercise' and its values cannot be restored.")

        # Changing field 'AnonymousProblem.exercise_post'
        db.alter_column('askbot_anonymousproblem', 'exercise_post_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['askbot.Post']))

        # User chose to not deal with backwards NULL issues for 'ExerciseView.exercise'
        raise RuntimeError("Cannot reverse this migration. 'ExerciseView.exercise' and its values cannot be restored.")

        # Changing field 'ExerciseView.exercise_post'
        db.alter_column('askbot_exerciseview', 'exercise_post_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['askbot.Post']))

        # Adding field 'PostRevision.exercise'
        db.add_column('askbot_postrevision', 'exercise', self.gf('django.db.models.fields.related.ForeignKey')(related_name='revisions', null=True, to=orm['askbot.Exercise'], blank=True), keep_default=False)

        # Adding field 'PostRevision.problem'
        db.add_column('askbot_postrevision', 'problem', self.gf('django.db.models.fields.related.ForeignKey')(related_name='revisions', null=True, to=orm['askbot.Problem'], blank=True), keep_default=False)

        # Adding unique constraint on 'PostRevision', fields ['problem', 'revision']
        db.create_unique('askbot_postrevision', ['problem_id', 'revision'])

        # Adding unique constraint on 'PostRevision', fields ['exercise', 'revision']
        db.create_unique('askbot_postrevision', ['exercise_id', 'revision'])
    ...
    models = {
        ...
        'askbot.anonymousproblem': {
            ...
            'exercise_post': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'anonymous_problems'", 'to': "orm['askbot.Post']"}),
        ...
        'askbot.exerciseview': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'exercise_post': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'viewed'", 'to': "orm['askbot.Post']"}),
        ...
        'askbot.thread': {
            ...
            'accepted_problem_post': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': "orm['askbot.Post']"}),
