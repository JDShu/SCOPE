...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Problem.text'
        db.add_column(u'problem', 'text', self.gf('django.db.models.fields.TextField')(null=True), keep_default=False)

        # Changing field 'Problem.html'
        db.alter_column(u'problem', 'html', self.gf('django.db.models.fields.TextField')(null=True))

        # Adding field 'Exercise.text'
        db.add_column(u'exercise', 'text', self.gf('django.db.models.fields.TextField')(null=True), keep_default=False)

        # Changing field 'Exercise.html'
        db.alter_column(u'exercise', 'html', self.gf('django.db.models.fields.TextField')(null=True))
    
    
    def backwards(self, orm):
        
        # Deleting field 'Problem.text'
        db.delete_column(u'problem', 'text')

        # Changing field 'Problem.html'
        db.alter_column(u'problem', 'html', self.gf('django.db.models.fields.TextField')())

        # Deleting field 'Exercise.text'
        db.delete_column(u'exercise', 'text')

        # Changing field 'Exercise.html'
        db.alter_column(u'exercise', 'html', self.gf('django.db.models.fields.TextField')())
