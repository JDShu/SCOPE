...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Repute.exercise'
        db.delete_column(u'repute', 'exercise_id')


    def backwards(self, orm):
        
        # Adding field 'Repute.exercise'
        db.add_column(u'repute', 'exercise', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['askbot.Exercise'], null=True, blank=True), keep_default=False)
