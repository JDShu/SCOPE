...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Thread.problem_accepted_at'
        db.add_column('askbot_thread', 'problem_accepted_at', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Thread.problem_accepted_at'
        db.delete_column('askbot_thread', 'problem_accepted_at')
