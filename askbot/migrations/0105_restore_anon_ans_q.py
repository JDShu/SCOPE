...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        #db.rename_column('askbot_anonymousproblem', 'exercise_post_id', 'exercise_id')
        innodb_ready_rename_column(
            orm=orm,
            models=self.__class__.models,
            table='askbot_anonymousproblem',
            old_column_name='exercise_post_id',
            new_column_name='exercise_id',
            app_model='askbot.anonymousproblem',
    ...
    def backwards(self, orm):
        db.rename_column('askbot_anonymousproblem', 'exercise_id', 'exercise_post_id')
