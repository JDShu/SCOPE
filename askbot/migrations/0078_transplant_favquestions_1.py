...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FavoriteExercise.thread'
        db.add_column(u'favorite_exercise', 'thread', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['askbot.Thread'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FavoriteExercise.thread'
        db.delete_column(u'favorite_exercise', 'thread_id')
