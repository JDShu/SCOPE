...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        #denorm field to make User.visit_exercise call quicker
        db.add_column(u'activity', 'exercise', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['askbot.Exercise'], null=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting model 'ActivityAuditStatus'
        db.delete_column(u'activity', 'exercise')
