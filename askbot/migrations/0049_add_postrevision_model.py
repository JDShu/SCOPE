...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('askbot_postrevision', (
            ...
            ('problem', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['askbot.Problem'], null=True, blank=True)),
            ('exercise', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['askbot.Exercise'], null=True, blank=True)),
        ))
