...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        post_types = ('exercise', 'problem')
        posts = orm['askbot.Post'].objects.filter(post_type__in=post_types)
        message = 'Move groupless exercises and problems to the global group'
        done_count = 0
        ...
        message = 'Copying group information from problems ' +\
            'and exercises to comments'
        done_count = 0
