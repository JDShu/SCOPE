...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Exercise.title'
        db.delete_column(u'exercise', 'title')


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Exercise.title'
        raise RuntimeError("Cannot reverse this migration. 'Exercise.title' and its values cannot be restored.")
