...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Thread.solution_count_tester'
        db.add_column('askbot_thread', 'solution_count_tester',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Thread.solution_count_tester'
        db.delete_column('askbot_thread', 'solution_count_tester')
    ...
    models = {
        ...
        'askbot.thread': {
            ...
            'solution_count': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'solution_count_tester': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'tagnames': ('django.db.models.fields.CharField', [], {'max_length': '125'}),
