...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Thread.problem_count'
        db.add_column('askbot_thread', 'problem_count', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Thread.problem_count'
        db.delete_column('askbot_thread', 'problem_count')
