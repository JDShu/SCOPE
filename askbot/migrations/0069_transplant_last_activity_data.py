...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for exercise in ProgressBar(orm.Exercise.objects.iterator(), num_exercises, message):
            ...
            thread.last_activity_at = exercise.last_activity_at
            thread.last_activity_by = exercise.last_activity_by
            thread.save()

        if  orm.Exercise.objects.exclude(last_activity_at=models.F('thread__last_activity_at')).exists() or \
            orm.Exercise.objects.exclude(last_activity_by=models.F('thread__last_activity_by')).exists():
