...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Exercise.last_activity_by'
        db.delete_column(u'exercise', 'last_activity_by_id')

        # Deleting field 'Exercise.last_activity_at'
        db.delete_column(u'exercise', 'last_activity_at')
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Exercise.last_activity_by'
        raise RuntimeError("Cannot reverse this migration. 'Exercise.last_activity_by' and its values cannot be restored.")

        # Adding field 'Exercise.last_activity_at'
        db.add_column(u'exercise', 'last_activity_at', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now), keep_default=False)
