...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('askbot_post', 'score')

        # Adding field 'Post.points'
        db.add_column('askbot_post', 'points',
                      self.gf('django.db.models.fields.IntegerField')(default=0, db_column='score'),
                      keep_default=False)

        # Deleting field 'Thread.score'
        db.delete_column('askbot_thread', 'score')

        # Adding field 'Thread.solution_count_test'
        db.add_column('askbot_thread', 'solution_count_test',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Thread.points'
        db.add_column('askbot_thread', 'points',
                      self.gf('django.db.models.fields.IntegerField')(default=0, db_column='score'),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column('askbot_post', 'score',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'Post.points'
        db.delete_column('askbot_post', 'score')
        ...
        # Deleting field 'Thread.solution_count_test'
        db.delete_column('askbot_thread', 'solution_count_test')

        # Deleting field 'Thread.points'
        db.delete_column('askbot_thread', 'score')
    ...
    models = {
        ...
        'askbot.thread': {
            ...
            'solution_count_test': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'tagnames': ('django.db.models.fields.CharField', [], {'max_length': '125'}),
