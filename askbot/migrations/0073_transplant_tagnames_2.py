...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Exercise.tagnames'
        db.delete_column(u'exercise', 'tagnames')


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Exercise.tagnames'
        raise RuntimeError("Cannot reverse this migration. 'Exercise.tagnames' and its values cannot be restored.")
