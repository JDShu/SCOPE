...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'ExerciseWidget.search_query'
        db.alter_column('askbot_exercisewidget', 'search_query', self.gf('django.db.models.fields.CharField')(default=None, max_length=50))
