...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # INFO: `default=False` matches the fact that Problem-s are never anonymous
        #       - so there's no need to do any post-processing (data migration)
        db.add_column(u'problem', 'is_anonymous', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Problem.is_anonymous'
        db.delete_column(u'problem', 'is_anonymous')
