...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Group.moderate_problems_to_enquirers'
        db.add_column('askbot_group', 'moderate_problems_to_enquirers',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Group.moderate_problems_to_enquirers'
        db.delete_column('askbot_group', 'moderate_problems_to_enquirers')
