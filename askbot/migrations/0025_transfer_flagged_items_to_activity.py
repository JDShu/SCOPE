...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        and set the denormalized value of exercise to the origin post
        of the flagged item
        """
        api = API(orm)
        ...
        for flag in orm.FlaggedItem.objects.all():
            ...
            activity.exercise = api.get_origin_post_from_content_object(flag)
    ...
    def backwards(self, orm):
        ...
        exercise reference is not deleted either
        """
