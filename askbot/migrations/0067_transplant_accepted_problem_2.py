...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Problem.accepted_at'
        db.delete_column(u'problem', 'accepted_at')

        # Deleting field 'Problem.accepted'
        db.delete_column(u'problem', 'accepted')

        # Deleting field 'Exercise.problem_accepted'
        db.delete_column(u'exercise', 'problem_accepted')


    def backwards(self, orm):
        
        # Adding field 'Problem.accepted_at'
        db.add_column(u'problem', 'accepted_at', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'Problem.accepted'
        db.add_column(u'problem', 'accepted', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Exercise.problem_accepted'
        db.add_column(u'exercise', 'problem_accepted', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
