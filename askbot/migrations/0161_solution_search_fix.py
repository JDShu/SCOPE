...
class Migration(DataMigration):
    """this migration is mostly the same as 22 and 106
    updating the postgres search setup
    so that it will accommodate solutions.
    Max Ward - 3-9-13
    """
    ...
    def forwards(self, orm):
        ...
        if 'postgresql_psycopg2' in askbot.get_database_engine_name():
            script_path = os.path.join(
                                ...
                                'search',
                                'postgresql',
                                'thread_and_post_models_03092013.plsql'
                            )
