...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Post.self_exercise'
        db.delete_column('askbot_post', 'self_exercise_id')

        # Deleting field 'Post.self_problem'
        db.delete_column('askbot_post', 'self_problem_id')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Post.self_exercise'
        db.add_column('askbot_post', 'self_exercise', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['askbot.Exercise'], blank=True), keep_default=False)

        # Adding field 'Post.self_problem'
        db.add_column('askbot_post', 'self_problem', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['askbot.Problem'], blank=True), keep_default=False)
