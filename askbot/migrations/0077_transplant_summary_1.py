...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'problem', 'summary', self.gf('django.db.models.fields.CharField')(default='', max_length=180), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Problem.summary'
        db.delete_column(u'problem', 'summary')
