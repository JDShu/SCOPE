...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Exercise.problem_count'
        db.delete_column(u'exercise', 'problem_count')


    def backwards(self, orm):
        
        # Adding field 'Exercise.problem_count'
        db.add_column(u'exercise', 'problem_count', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)
