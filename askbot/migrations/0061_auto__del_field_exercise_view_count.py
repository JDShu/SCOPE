...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Exercise.view_count'
        db.delete_column(u'exercise', 'view_count')


    def backwards(self, orm):
        
        # Adding field 'Exercise.view_count'
        db.add_column(u'exercise', 'view_count', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)
