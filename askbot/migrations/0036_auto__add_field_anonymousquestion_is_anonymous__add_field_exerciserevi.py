...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AnonymousExercise.is_anonymous'
        db.add_column('askbot_anonymousexercise', 'is_anonymous', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Adding field 'ExerciseRevision.is_anonymous'
        db.add_column(u'exercise_revision', 'is_anonymous', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Adding field 'Exercise.is_anonymous'
        db.add_column(u'exercise', 'is_anonymous', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'AnonymousExercise.is_anonymous'
        db.delete_column('askbot_anonymousexercise', 'is_anonymous')

        # Deleting field 'ExerciseRevision.is_anonymous'
        db.delete_column(u'exercise_revision', 'is_anonymous')

        # Deleting field 'Exercise.is_anonymous'
        db.delete_column(u'exercise', 'is_anonymous')
