...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Activity.exercise_post'
        db.add_column(u'activity', 'exercise_post', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['askbot.Post'], null=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Activity.exercise_post'
        db.delete_column(u'activity', 'exercise_post_id')
