...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Repute.exercise'
        db.alter_column(u'repute', 'exercise_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['askbot.Exercise'], null=True, blank=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Repute.exercise'
        db.alter_column(u'repute', 'exercise_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['askbot.Exercise']))
