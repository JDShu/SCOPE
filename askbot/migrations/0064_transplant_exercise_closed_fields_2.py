...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Exercise.closed_at'
        db.delete_column(u'exercise', 'closed_at')

        # Deleting field 'Exercise.closed_by'
        db.delete_column(u'exercise', 'closed_by_id')

        # Deleting field 'Exercise.close_reason'
        db.delete_column(u'exercise', 'close_reason')

        # Deleting field 'Exercise.closed'
        db.delete_column(u'exercise', 'closed')


    def backwards(self, orm):
        
        # Adding field 'Exercise.closed_at'
        db.add_column(u'exercise', 'closed_at', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'Exercise.closed_by'
        db.add_column(u'exercise', 'closed_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='closed_exercises', null=True, to=orm['auth.User'], blank=True), keep_default=False)

        # Adding field 'Exercise.close_reason'
        db.add_column(u'exercise', 'close_reason', self.gf('django.db.models.fields.SmallIntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Exercise.closed'
        db.add_column(u'exercise', 'closed', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
