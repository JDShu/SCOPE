...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        try:
            db.rename_table('forum_anonymousproblem', 'askbot_anonymousproblem')
            db.rename_table('forum_anonymousexercise', 'askbot_anonymousexercise')
            db.rename_table('forum_emailfeedsetting', 'askbot_emailfeedsetting')
            db.rename_table('forum_markedtag', 'askbot_markedtag')
            db.rename_table('forum_exerciseview', 'askbot_exerciseview')
    ...
    def backwards(self, orm):
        if app_dirname == 'forum':
            db.rename_table('askbot_anonymousproblem', 'forum_anonymousproblem')
            db.rename_table('askbot_anonymousexercise', 'forum_anonymousexercise')
            db.rename_table('askbot_emailfeedsetting', 'forum_emailfeedsetting')
            db.rename_table('askbot_markedtag', 'forum_markedtag')
            db.rename_table('askbot_exerciseview', 'forum_exerciseview')
    ...
    if app_dir_name == 'forum':
        models = {
            ...
            'forum.exercise': {
                ...
                'favorited_by': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'favorite_exercises'", 'symmetrical': 'False', 'through': "'FavoriteExercise'", 'to': "orm['auth.User']"}),
                ...
                'summary': ('django.db.models.fields.CharField', [], {'max_length': '180'}),
                'tagnames': ('django.db.models.fields.CharField', [], {'max_length': '125'}),
                'tags': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'exercises'", 'symmetrical': 'False', 'to': "orm['forum.Tag']"}),
                'text': ('django.db.models.fields.TextField', [], {'null': 'True'}),
                'title': ('django.db.models.fields.CharField', [], {'max_length': '300'}),
