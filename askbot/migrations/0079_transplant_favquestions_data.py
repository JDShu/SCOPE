...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        message = "Connecting favorite exercises to threads"
        num_favs = orm.FavoriteExercise.objects.count()
        for fav in ProgressBar(orm.FavoriteExercise.objects.iterator(), num_favs, message):
            fav.thread = fav.exercise.thread
            fav.save()
