...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Exercise.favourite_count'
        db.delete_column(u'exercise', 'favourite_count')


    def backwards(self, orm):
        
        # Adding field 'Exercise.favourite_count'
        db.add_column(u'exercise', 'favourite_count', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)
