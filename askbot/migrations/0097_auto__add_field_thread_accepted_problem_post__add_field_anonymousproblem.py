...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('askbot_thread', 'accepted_problem_post', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['askbot.Post']), keep_default=False)

        # Adding field 'AnonymousProblem.exercise_post'
        db.add_column('askbot_anonymousproblem', 'exercise_post', self.gf('django.db.models.fields.related.ForeignKey')(related_name='anonymous_problem_posts', null=True, to=orm['askbot.Post']), keep_default=False)

        # Adding field 'ExerciseView.exercise_post'
        db.add_column('askbot_exerciseview', 'exercise_post', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['askbot.Post']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Thread.accepted_problem_post'
        db.delete_column('askbot_thread', 'accepted_problem_post_id')

        # Deleting field 'AnonymousProblem.exercise_post'
        db.delete_column('askbot_anonymousproblem', 'exercise_post_id')

        # Deleting field 'ExerciseView.exercise_post'
        db.delete_column('askbot_exerciseview', 'exercise_post_id')
    ...
    models = {
        ...
        'askbot.anonymousproblem': {
            ...
            'exercise_post': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'anonymous_problem_posts'", 'null': 'True', 'to': "orm['askbot.Post']"}),
        ...
        'askbot.exerciseview': {
            ...
            'exercise_post': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'null': 'True', 'to': "orm['askbot.Post']"}),
