...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for exercise in ProgressBar(orm.Exercise.objects.iterator(), num_exercises, message):
            exercise.thread.followed_by.clear() # just in case someone reversed this migration
            exercise.thread.followed_by.add(*list(exercise.followed_by.iterator()))

            if exercise.followed_by.count() != exercise.thread.followed_by.count():
