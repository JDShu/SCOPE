...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Repute.exercise_post'
        db.add_column(u'repute', 'exercise_post', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['askbot.Post'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Repute.exercise_post'
        db.delete_column(u'repute', 'exercise_post_id')
