...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Exercise.thread'
        db.add_column(u'exercise', 'thread', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='exercises', unique=True, null=True, to=orm['askbot.Thread']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Exercise.thread'
        db.delete_column(u'exercise', 'thread_id')
