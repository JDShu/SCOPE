...
LARGE_SITE_MODE_SETTINGS = {
    ...
    'MIN_REP_TO_PROBLEM_OWN_EXERCISE': 25,
    'MIN_REP_TO_ACCEPT_OWN_PROBLEM': 50,
    ...
    'MIN_REP_TO_CLOSE_OWN_EXERCISES': 250,
    'MIN_REP_TO_RETAG_OTHERS_EXERCISES': 500,
    'MIN_REP_TO_REOPEN_OWN_EXERCISES': 500,
    'MIN_REP_TO_EDIT_WIKI': 750,
    'MIN_REP_TO_EDIT_OTHERS_POSTS': 2000,
    'MIN_REP_TO_VIEW_OFFENSIVE_FLAGS': 2000,
    'MIN_REP_TO_CLOSE_OTHERS_EXERCISES': 2000,
    'MIN_REP_TO_LOCK_POSTS': 4000,
    'MIN_REP_TO_HAVE_STRONG_URL': 250,
    #badge settings
    'NOTABLE_EXERCISE_BADGE_MIN_VIEWS': 250,
    'POPULAR_EXERCISE_BADGE_MIN_VIEWS': 150,
    'FAMOUS_EXERCISE_BADGE_MIN_VIEWS': 500,
